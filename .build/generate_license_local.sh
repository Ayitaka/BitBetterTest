...
if [ "${1,,}" == "help" ] || [ "${1,,}" == "--help" ] || [ "${1,,}" == "-h" ]; then
		...
		echo "https://github.com/Ayitaka/BitBetter"
		echo ""
		echo "Originally by:"
        ...
        echo "Syntax: generate_license.sh"
        echo ""
        echo "To use command-line:"
        echo "Syntax: generate_license.sh user USERS_NAME EMAIL USERS_GUID"
        echo "Syntax: generate_license.sh org ORGS_NAME EMAIL BUSINESS_NAME"
        echo ""
